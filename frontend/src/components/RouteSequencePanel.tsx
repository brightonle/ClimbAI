  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm font-medium text-gray-700">{selectedHolds.length} holds selected</span>
        <button onClick={onClear} className="text-xs text-red-500 hover:text-red-600 transition-colors">
          Clear all
        </button>
      </div>
        ...
        {selectedHolds.map((s, i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <span className="text-gray-700 capitalize">{s.role}</span>
